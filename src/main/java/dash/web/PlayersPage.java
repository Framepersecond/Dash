...
public class PlayersPage {
    ...
    public static String render() {
        ...
        for (Player p : Bukkit.getOnlinePlayers()) {
            ...
            if (canModerate) {
                tableRows.append("<a href='/players/").append(p.getName())
            ...
            if (canKick) {
                tableRows.append("<form action='/action' method='post' class='inline' onsubmit=\"return confirm('Kick ")
                        .append(p.getName())
            ...
            if (canBan) {
                tableRows.append("<form action='/action' method='post' class='inline' onsubmit=\"return confirm('Ban ")
                        .append(p.getName())
            ...
            if (canModerate) {
                tableRows.append("<form action='/action' method='post' class='inline'><input type='hidden' name='action' value='freeze'><input type='hidden' name='player' value='")
                        .append(p.getName()).append("'>")
        ...
        String content = HtmlTemplate.statsHeader() +
                ...
                "<input type=\"text\" id=\"player-search\" placeholder=\"Search players...\" class=\"bg-slate-800 border border-slate-600 rounded-lg px-4 py-2 text-sm text-white placeholder-slate-500 focus:border-primary outline-none w-full sm:w-64\">\n"
                +
                "</div>\n" +
                "</div>\n" +
                ...
                "<th class=\"px-4 py-3 whitespace-nowrap\">Ping</th>\n" +
