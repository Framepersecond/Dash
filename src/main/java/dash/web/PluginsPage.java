    ...
    public static String render() {
        ...
        for (Plugin plugin : Bukkit.getPluginManager().getPlugins()) {
            ...
            if (canManagePlugins) {
                ...
                pluginsHtml.append("<form action='/action' method='post' class='inline'>\n")
                ...
                if (pluginJar != null && !pluginJar.isBlank()) {
                    pluginsHtml.append("<form action='/action' method='post' class='inline' onsubmit=\"return confirm('Delete plugin file? Restart required.');\">\n")
                            ...
                            .append("<button class=\"px-3 py-1 rounded-lg text-xs font-semibold bg-rose-500/20 text-rose-300 hover:bg-rose-500/30 transition-colors\">Delete File</button>\n")
                            .append("</form>\n");
                }
            }
