...
public class UsersPage {
    ...
    public static String render(Map<String, WebAuth.UserInfo> users, Iterable<String> roles, Map<String, Integer> roleValues,
        ...
        if (actorIsMainAdmin) {
            ...
            actorRoleValue = roleValues.getOrDefault(actorInfo.role().toUpperCase(Locale.ROOT), 0);
        }
        ...
        for (WebAuth.UserInfo user : users.values()) {
            ...
            int userRoleValue = user.mainAdmin() ? highestRoleValue + 1 : roleValues.getOrDefault(selectedRole.toUpperCase(Locale.ROOT), 0);
            ...
            for (String role : roles) {
                int candidateValue = roleValues.getOrDefault(role.toUpperCase(Locale.ROOT), 0);
